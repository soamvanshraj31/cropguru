...
joblib.dump(train_generator.class_indices, 'disease_class_names.pkl')
print("Model saved as crop_disease_model.h5 and class names as disease_class_names.pkl")
