...
df = pd.read_csv('Agriculture_Market_Prices.csv')
...
# 3.2 Train ARIMA
# Order (p,d,q) = (5,1,0) is an example. In real code, we use Grid Search to find best values.
# p=5 (Past 5 days affect today), d=1 (Differencing once), q=0 (Moving Average)
arima_model = ARIMA(train_data, order=(5, d_value, 0))
